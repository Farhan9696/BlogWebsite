...
var CreateBlogComponent = /** @class */ (function () {
    function CreateBlogComponent(http, router) {
        this.http = http;
        this.router = router;
    }
    ...
    CreateBlogComponent.prototype.postBlog = function () {
        var _this = this;
...
var EditBlogComponent = /** @class */ (function () {
    function EditBlogComponent(activatedRoute, http, router) {
    ...
    EditBlogComponent.prototype.postBlog = function () {
        var _this = this;
...
var ListBlogComponent = /** @class */ (function () {
    function ListBlogComponent(http) {
        this.http = http;
    }
    ListBlogComponent.prototype.ngOnInit = function () {
        this.loadData();
    };
    ListBlogComponent.prototype.loadData = function () {
        var _this = this;
        this.http.get('https://demobl0g.herokuapp.com/api/blogs')
            .toPromise()
            .then(function (response) {
    ...
    ListBlogComponent.prototype.deleteBlog = function (id) {
        var _this = this;
    ...
    ListBlogComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var ViewBlogComponent = /** @class */ (function () {
    function ViewBlogComponent(activatedRoute, http) {
        this.activatedRoute = activatedRoute;
        this.http = http;
    }
    ViewBlogComponent.prototype.ngOnInit = function () {
        ...
        this.http.get("https://demobl0g.herokuapp.com/api/blogs/" + this.activatedRoute.snapshot.paramMap.get('id'))
            .toPromise()
            .then(function (response) {
            _this.blogContent = response;
        }, function (error) {
            console.log(error);
        });
    };
    ViewBlogComponent.ctorParameters = function () { return [
